...
public class ProcessModelResource {
	...
	@RolesAllowedIfWebVersion({ "User", "Admin" })
	public Response addRelatedProcessModel(@RestPath Long projectId, Long id, RelatedProcessModelRequest request) {
	...
	/**
	 * This method gets the names and the corresponding ids of all process models in order to show them as a list in the
	 * process list in the frontend
	 */
	@GET
	@Path("/project/{projectId}/process-model")
